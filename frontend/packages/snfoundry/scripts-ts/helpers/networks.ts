...
const providerDevnet = RPC_URL_DEVNET &&
  new RpcProvider({ nodeUrl: RPC_URL_DEVNET });
const deployerDevnet = ACCOUNT_ADDRESS_DEVNET &&
  PRIVATE_KEY_DEVNET &&
...
const deployerSepolia = process.env.ACCOUNT_ADDRESS_SEPOLIA &&
...
const deployerMainnet = process.env.ACCOUNT_ADDRESS_MAINNET &&
